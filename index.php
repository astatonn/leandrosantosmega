...
<head>
    ...
    <meta name="description"
        content="Solicite um orçamento para mixagem e masterização de músicas com um dos melhores engenheiros de áudio do mercado">
...
<body>
    ...
    <main class="conteudo">
        ...
        <section class="conteudo-principal" id="home-head">
            ...
            <img class="conteudo-principal-imagem" src="assets/img/logonome.png"
                alt="Imagem de Perfil do Leandro Santos">
        </section>
        ...
        <section class="conteudo-servicos">
            ...
            <div class="servicos-disponiveis">
                ...
                <div class="conteudo-servico">
                    <div class="servico">
                        <img src="assets/img/masterizacao.png" alt="ícone de masterização de som"
        ...
        <section class="conteudo-portifolio">
            ...
            <div class="carrossel-trabalhos">
                ...
                <div class="ultimos-trabalhos">
                    <div class="conteudo-ultimo-trabalho">
                        <img src="assets/img/portifolio/seu_sorrir.jpg" alt="ícone de mixagem de som"
                            class="portifolio-imagem">
                ...
                <div class="ultimos-trabalhos">
                    <div class="conteudo-ultimo-trabalho">
                        <img src="assets/img/portifolio/num_love.jpg" alt="ícone de mixagem de som"
                            class="portifolio-imagem">
                ...
                <div class="ultimos-trabalhos">
                    <div class="conteudo-ultimo-trabalho">
                        <img src="assets/img/portifolio/meu_dengo.jpg" alt="ícone de mixagem de som"
                            class="portifolio-imagem">
        ...
        <section class="conteudo-sobre">
            ...
            <div class="sobre-conteudo">
                <div class="conteudo-sobre-texto">
                    <p> Nascido em 22 de janeiro de 1997, natural da cidade de Duque de Caxias, Rio de Janeiro, Leandro
                        Santos reside em Canoas, cidade no entorno da grande Porto Alegre no Rio Grande do Sul.
                        Despertou seu interesse musical com cerca de 7 anos de idade, influenciado por seu pai que era
                        músico.
                        Com 11 anos começou a estudar contrabaixo e, aos 13, foi aprovado no processo seletivo da escola
                        de música
                        Villa Lobos, no centro do Rio de Janeiro. Após o término de curso, continuou sua busca por
        ...
        <section class="conteudo-orcamento">
            ...
            <form class="conteudo-orcamento-formulario" id="formularioinformacao" action="controller/submit.php"
                method="POST">
                ...
                <div class="campo-orcamento">
                    ...
                    <textarea id="descricao" name="descricao" placeholder="Descreva sua solicitação até 1000 caracteres"
                        maxlength="1000" minlength="50" form="formularioinformacao" resizable="false"></textarea>
                </div>
